...
import Spinner from "@/components/Spinner"; // Make sure this import path is correct
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            ...
            try {
                ...
                console.log('Products:', productsArray); // Check what is being set
            } catch (error) {
                ...
                if (loadingTime < MIN_LOADING_TIME) {
                    setTimeout(() => setIsLoading(false), MIN_LOADING_TIME - loadingTime);
                } else {
                    setIsLoading(false);
                }
            }
